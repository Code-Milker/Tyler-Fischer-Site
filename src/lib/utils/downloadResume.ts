...
export async function downloadResumePDF() {
	...
	try {
		...
		// Override Tailwind prose color variables for black text
		offscreenDiv.style.setProperty('--tw-prose-body', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-headings', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-lead', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-links', '#0000EE');
		offscreenDiv.style.setProperty('--tw-prose-bold', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-counters', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-bullets', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-quotes', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-quote-borders', '#d1d5db');
		offscreenDiv.style.setProperty('--tw-prose-captions', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-kbd', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-code', '#000000');
		offscreenDiv.style.setProperty('--tw-prose-th-borders', '#d1d5db');
		offscreenDiv.style.setProperty('--tw-prose-td-borders', '#e5e7eb');
		// Render SvelteMarkdown component into it
		mdComponent = new SvelteMarkdown({
			target: offscreenDiv,
			props: { source: resumeMd }
		});
