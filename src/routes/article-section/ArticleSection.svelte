	...
	{#each articles as article, i}
		...
		>
			<div class="flex flex-col md:flex-row p-4 md:p-6">
				<div class="flex-shrink-0 mb-4 md:mb-0 md:mr-6 p-2">
					<img
						src={article.image}
						alt={article.title}
						class="w-full md:w-[200px] aspect-square rounded-lg object-cover"
					/>
				</div>
			...
			{#if expanded[i]}
				<div class="px-4 md:px-6 py-8 border-t border-quaternary">
